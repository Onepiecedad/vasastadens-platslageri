      ...
      <section className="py-24 bg-light">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none animate-fade-in-up">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-granite mb-6 mt-12">Ändamål och laglig grund</h2>
            <p className="text-neutral mb-4">
              Vi behandlar dina personuppgifter för att:
            </p>
            <ul className="list-disc list-inside text-neutral space-y-2 mb-4">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-granite mb-6 mt-12">Hur länge sparar vi dina uppgifter?</h2>
            <p className="text-neutral mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-granite mb-6 mt-12">Dina rättigheter</h2>
            <p className="text-neutral mb-4">
              Du har rätt att:
            </p>
            <ul className="list-disc list-inside text-neutral space-y-2 mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-granite mb-6 mt-12">Cookies</h2>
            <p className="text-neutral mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-granite mb-6 mt-12">Kontakta oss</h2>
            <p className="text-neutral mb-4">
            ...
            <p className="text-neutral/70 text-sm mt-12">
